...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MVC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC3MVC11AppDelegate")
...
SWIFT_CLASS("_TtC3MVC18BaseViewController")
...
SWIFT_CLASS("_TtC3MVC13CustomeButton")
...
SWIFT_CLASS("_TtC3MVC11CustomeView")
...
SWIFT_CLASS("_TtC3MVC6HomeVC")
@interface HomeVC : BaseViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified HomeTV;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface HomeVC (SWIFT_EXTENSION(MVC)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC3MVC20ProductTableViewCell")
...
@property (nonatomic, weak) IBOutlet CustomeView * _Null_unspecified ProductView;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC3MVC13SceneDelegate")
